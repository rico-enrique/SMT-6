            ...
            success: function (response) {
                ...
                $.each(response, function (key, val) {
                    out += `<tr>
                        ...
                        <td><button type="button" id="btn-ubah" class="btn btn-warning btn-ubah" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id=${val.idpelanggan}>UBAH</button></td>
                    </tr>`;
                });
